...
\author{
\IEEEauthorblockN{Minh Triet Pham\textsuperscript{1}}
...
\IEEEauthorblockN{Quynh Chi Dang\textsuperscript{1}}
\IEEEauthorblockA{\textsuperscript{1}\textit{School of Computing and Information Systems} \\
\textit{The University of Melbourne}\\
Melbourne, Victoria, Australia \\
quynhchid@student.unimelb.edu.au}
\IEEEauthorblockN{Le Nhat Tan\textsuperscript{2,3}}
...
\IEEEauthorblockA{\textsuperscript{3}\textit{Vietnam National University - Ho Chi Minh City (VNU-HCM)}\\
Ho Chi Minh City, Vietnam \\
